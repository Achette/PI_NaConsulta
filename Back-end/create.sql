...
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('John', 'Smith', 'masculino', 'john.s@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Maria', 'Garcia', 'feminino', 'maria@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Robert', 'Johnson', 'masculino', 'robert.j@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Cris', 'Brown', 'masculino', 'cris@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Emily', 'Johnson', 'feminino', 'emily.j@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Michael', 'Smith', 'masculino', 'michael.s@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Alex', 'Jasmin', 'masculino', 'alex.j@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Doroty', 'Davis', 'feminino', 'doroty@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (first_Name, last_Name, gender, email, password) VALUES ('Daniel', 'Wilson', 'masculino', 'daniel.w@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
...
INSERT INTO tb_user_role (user_id, role_id) VALUES (18, 3);
INSERT INTO tb_user_role (user_id, role_id) VALUES (19, 3);
...
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-04-04T10:30:00Z', 'fratura no tornozelo', 'inchaço e dificuldade de movimentação após queda', 7, 13, NOW());
...
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-04-12T09:30:00Z', 'conjuntivite', 'coceira, vermelhidão e secreção nos olhos', 7, 14, NOW());
...
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-04-20T09:30:00Z', 'ansiedade', 'preocupação excessiva, inquietação e tensão muscular', 17, 15, NOW());
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-05-21T16:20:00Z', 'transtorno bipolar', 'mudanças de humor extremas, alternando entre mania e depressão', 12, 3, NOW());
...
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-04-28T09:30:00Z', 'intolerância à lactose', 'inchaço abdominal e desconforto após consumo de laticínios', 7, 16, NOW());
...
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2023-06-30T11:00:00Z', 'obesidade', 'ganho de peso excessivo e dificuldade em emagrecer', 14, 8, NOW());
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2024-06-01T11:00:00Z', '', '', 17, 12, NOW());
INSERT INTO tb_appointment (date, diagnosis, symptom, user_id, doctor_id, created_At) VALUES (TIMESTAMP WITH TIME ZONE '2024-07-02T16:20:00Z', '', '', 19, 16, NOW());
